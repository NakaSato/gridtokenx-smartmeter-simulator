...
class SimulatorConfig:
    ...
    # Solar Configuration
    SOLAR_EFFICIENCY_MIN = float(os.getenv("SOLAR_PANEL_EFFICIENCY_MIN", "0.85"))
    SOLAR_EFFICIENCY_MAX = float(os.getenv("SOLAR_PANEL_EFFICIENCY_MAX", "0.95"))
    BASE_GENERATION_MIN = float(os.getenv("BASE_GENERATION_MIN", "10.0"))
    BASE_GENERATION_MAX = float(os.getenv("BASE_GENERATION_MAX", "20.0"))
    ...
    MIN_SELL_PRICE = float(os.getenv("MIN_SELL_PRICE", "2.20"))
    MAX_SELL_PRICE = float(os.getenv("MAX_SELL_PRICE", "3.00"))
    MIN_BUY_PRICE = float(os.getenv("MIN_BUY_PRICE", "4.00"))
    MAX_BUY_PRICE = float(os.getenv("MAX_BUY_PRICE", "4.80"))
    GRID_FEED_IN_RATE = float(os.getenv("GRID_FEED_IN_RATE", "2.20"))
    GRID_PURCHASE_RATE = float(os.getenv("GRID_PURCHASE_RATE", "4.50"))
    ...
    BATTERY_CAPACITY_MIN = float(os.getenv("BATTERY_CAPACITY_MIN", "10.0"))
    BATTERY_CAPACITY_MAX = float(os.getenv("BATTERY_CAPACITY_MAX", "30.0"))
    BATTERY_EFFICIENCY_MIN = float(os.getenv("BATTERY_EFFICIENCY_MIN", "0.90"))
    BATTERY_EFFICIENCY_MAX = float(os.getenv("BATTERY_EFFICIENCY_MAX", "0.95"))

    # Meter Type Distribution
    SOLAR_PROSUMER_RATIO = float(os.getenv("SOLAR_PROSUMER_RATIO", "0.40"))
    GRID_CONSUMER_RATIO = float(os.getenv("GRID_CONSUMER_RATIO", "0.35"))
    HYBRID_PROSUMER_RATIO = float(os.getenv("HYBRID_PROSUMER_RATIO", "0.20"))
    BATTERY_STORAGE_RATIO = float(os.getenv("BATTERY_STORAGE_RATIO", "0.05"))

    # REC Configuration
    REC_CERTIFICATION_ENABLED = (
        os.getenv("REC_CERTIFICATION_ENABLED", "true").lower() == "true"
    )
    ...
    WEATHER_CHANGE_FREQUENCY = int(os.getenv("WEATHER_CHANGE_FREQUENCY", "5"))
    ENABLE_MARKET_DYNAMICS = (
        os.getenv("ENABLE_MARKET_DYNAMICS", "true").lower() == "true"
    )
