...
export const PriceCard = ({
    ...
    return (
        <div className={`p-6 rounded-2xl border ${statusColors[status]} backdrop-blur-sm`}>
            <div className="flex items-center justify-between mb-4">
                ...
                {trend && (
                    <div className={`flex items-center gap-1 text-sm font-bold ${
                        trend === 'up' ? 'text-rose-400' : trend === 'down' ? 'text-emerald-400' : 'text-slate-400'
                    }`}>
            ...
            <div className="space-y-1">
                ...
                <div className="text-3xl font-black text-white">
                    {typeof value === 'number' ? value.toLocaleString('en-TH', { maximumFractionDigits: 3 }) : value}
