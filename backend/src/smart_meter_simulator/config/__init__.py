...
def __dir__():
    ...
    return list(globals().keys()) + [
        ...
        "SOLAR_EFFICIENCY_MIN",
        "SOLAR_EFFICIENCY_MAX",
        "BASE_GENERATION_MIN",
        "BASE_GENERATION_MAX",
        "BASE_CONSUMPTION_MIN",
        "BASE_CONSUMPTION_MAX",
        "NOISE_FACTOR_MIN",
        "NOISE_FACTOR_MAX",
        "MIN_SELL_PRICE",
        "MAX_SELL_PRICE",
        ...
        "BATTERY_EFFICIENCY_MIN",
        "BATTERY_EFFICIENCY_MAX",
        "REC_CERTIFICATION_ENABLED",
        "CARBON_OFFSET_RATE",
        "SIMULATION_SPEED_MULTIPLIER",
        "RANDOM_SEED",
        "WEATHER_CHANGE_FREQUENCY",
        "ENABLE_MARKET_DYNAMICS",
        "WEATHER_SUNNY_WEIGHT",
        "WEATHER_PARTLY_CLOUDY_WEIGHT",
        "WEATHER_CLOUDY_WEIGHT",
        "WEATHER_OVERCAST_WEIGHT",
        "WEATHER_RAINY_WEIGHT",
        "EV_BATTERY_CAPACITY_MIN",
        "EV_BATTERY_CAPACITY_MAX",
        "EV_CHARGE_RATE_KW",
        "EV_V2G_DISCHARGE_RATE_KW",
        "EV_V2G_THRESHOLD_SOC",
        "SUBMIT_READING_ENDPOINT",
        "SUBMIT_BATCH_ENDPOINT",
        "REGISTER_METER_ENDPOINT",
        "AUCTION_BID_ENDPOINT",
        "DEFAULT_AUCTION_BATCH",
    ]
