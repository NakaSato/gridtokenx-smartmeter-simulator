...
def clean_feature(feature: Dict, file_type: str) -> Dict:
    ...
    if file_type == "substation":
        ...
        new_props = {
            "name": props.get("name") or props.get("name:en") or f"Samui_{power_type}_{props.get('osmid')}",
            "type": power_type,
        ...
        new_props = {
            "name": props.get("name_e") or props.get("sub_en") or props.get("prov_namee") or f"Zone_{props.get('fid')}",
            "name_th": props.get("name_t") or props.get("sub_th") or props.get("prov_namt"),
    ...
    if "fid" in props: new_props["fid"] = props["fid"]
