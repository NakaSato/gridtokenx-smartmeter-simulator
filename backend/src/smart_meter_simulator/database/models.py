...
from sqlalchemy import Integer, String, Numeric, DateTime, Text, ForeignKey, Index
...
class Substation(Base):
    ...
    power_lines_from: Mapped[List["PowerLine"]] = relationship(
        "PowerLine",
        foreign_keys="PowerLine.from_substation_id",
        back_populates="from_substation",
    )
    power_lines_to: Mapped[List["PowerLine"]] = relationship(
        "PowerLine",
        foreign_keys="PowerLine.to_substation_id",
        back_populates="to_substation",
    )
    transformers: Mapped[List["Transformer"]] = relationship(
        "Transformer", back_populates="substation"
    )
...
class PowerLine(Base):
    ...
    from_substation: Mapped[Optional["Substation"]] = relationship(
        "Substation",
        foreign_keys=[from_substation_id],
        back_populates="power_lines_from",
    )
