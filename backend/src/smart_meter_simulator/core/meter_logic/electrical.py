...
def apply_droop_control(gen: float, cons: float, frequency: float) -> Tuple[float, float]:
...
def calculate_electrical_params(gen: float, cons: float, accuracy_class_val: float, channels: set) -> dict:
